...
This is the second linear model results above, and it gives significant result for FX change. It means have enough evidence to believe FX losses has affect on the local currency TRY depreciate against a major currency such as USD.
